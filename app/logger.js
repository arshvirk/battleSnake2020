...
const writeLogs = (data) => {
  if (consoleEnable) console.log(exLog);
...
const error = (message, turn = null) => {
  log += `ERROR: ${message}\n`
  if (consoleEnable) console.log(`ERROR: ${message}`);
...
const status = message => {
  if (true) {
    log += `${message}\n`
    if (consoleEnable) console.log(`${message}`);
  }
}
...
const debug = message => {
  if (true) {
    log += `DEBUG: ${message}\n`
    if (consoleEnable) console.log(`DEBUG: ${message}`);
  }
}
